...
/* #define MLK_CONFIG_CUSTOM_ZEROIZE
   ...
   #include <stdint.h>
   #include "src/sys.h"
   static MLK_INLINE void mlk_zeroize(void *ptr, ulong len)
   {
       ... your implementation ...
   }
   #endif
 ...
 * int randombytes(u8int *out, ulong outlen). It is expected to return
...
/* #define MLK_CONFIG_CUSTOM_RANDOMBYTES
   ...
   #include <stdint.h>
   #include "src/sys.h"
   static MLK_INLINE int mlk_randombytes(u8int *ptr, ulong len)
   {
       ... your implementation ...
       return 0;
   }
 ...
 * void *mlk_memcpy(void *dest, const void *src, ulong n)
 */
/* #define MLK_CONFIG_CUSTOM_MEMCPY
   #if !defined(__ASSEMBLER__)
   #include <stdint.h>
   #include "src/sys.h"
   static MLK_INLINE void *mlk_memcpy(void *dest, const void *src, ulong n)
   {
       ... your implementation ...
   }
   #endif
 ...
 * void *mlk_memset(void *s, int c, ulong n)
 */
/* #define MLK_CONFIG_CUSTOM_MEMSET
   #if !defined(__ASSEMBLER__)
   #include <stdint.h>
   #include "src/sys.h"
   static MLK_INLINE void *mlk_memset(void *s, int c, ulong n)
   {
       ... your implementation ...
   }
   #endif
